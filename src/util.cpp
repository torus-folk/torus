...
const char * const BITCOIN_CONF_FILENAME = "torus.conf";
const char * const BITCOIN_PID_FILENAME = "torusd.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Torus
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Torus
    // Mac: ~/Library/Application Support/Torus
    // Unix: ~/.torus
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Torus";
#else
    // Unix
