...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Torus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and torus: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Torus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Torus addresses"));
    ...
    openAction->setStatusTip(tr("Open a torus: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Torus command-line options").arg(tr(PACKAGE_NAME)));

    openChatroomAction = new QAction(QIcon(":/icons/torus"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open the Torus Discord in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/torus"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.torus.net in a web browser."));
...
void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.torus.net"));
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Torus network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Torus"); // default title
